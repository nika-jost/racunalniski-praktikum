...
\usepackage{array}
\newcommand{\ZZ}{\mathbb{Z}} %za pisan bi bil mathcal{}, ta pa je za te
...
\title{Matematični izraziin uporaba paketa \texttt{beamer}}
%\subtitle{\emph{Matematičnih} nalog ni treba reševati!}

\author{inštitut: Fakulteta za matematiko in fiziko}
%date{}
